...
import { Critical, EmissionsManagement, EnergyRenewable, IbmUnstructuredDataProcessor, Important, TrashCan, VersionMajor, VersionMinor } from '@carbon/icons-react';
  ...
  >
    ...
    <div style={{ display: 'flex', gap: '0.5rem' }}>
      ...
      <Button
        ...
        style={{ color: '#da1e28' }}
        renderIcon={Critical}
        // renderIcon={EnergyRenewable}
        // iconDescription="Energy Settings"
      >
        Critical
        </Button>
      <Button
      ...
      <Column sm={4} md={8} lg={16}>
        <div style={{ display: 'flex', gap: '2rem', marginTop: '2rem' }}>
          <MetricCard name="CO₂ Emissions (tons)" value={metrics.co2_emissions} icon={<EmissionsManagement size={32} fill={"#42be65"}/>}/>
          <MetricCard name="Waste Level (%)" value={metrics.waste_level} icon={<TrashCan size={32} fill={"#da1e28"}/>} />
          <MetricCard name="Energy Usage (kWh)" value={metrics.energy_usage} icon={<EnergyRenewable size={32} fill={"#be95ff"}/>} />
